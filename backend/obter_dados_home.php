...
class Circuito {
    ...
    public function getFiltros($data) {
        $query_filters = "SELECT informacoes_circuito.solicitante, informacoes_circuito.circuito, informacoes_circuito.fornecedor, 
        comercial.banda, informacoes_circuito.tipo, informacoes_circuito.status_circuito, informacoes_circuito.status_detalhamento
...
// Cria uma instância da classe Circuito
$circuito = new Circuito($conn);
...
$filtros_dados = $circuito->getFiltros($data);
...
if (count($rows_filters) > 0) {
    ...
    $filtros = array(
        'circuito' => $circuito->getDistinctValues('informacoes_circuito', 'circuito'),
        'contrato' => $circuito->getDistinctValues('comercial', 'contrato'),
        'status_mcom' => $circuito->getDistinctValues('informacoes_circuito', 'status_circuito'),
        'status_tlb' => $circuito->getDistinctValues('informacoes_circuito', 'status_tlb'),
        'remessa' => $circuito->getDistinctValues('informacoes_circuito', 'remessa'),
        'modalidade' => $circuito->getDistinctValues('comercial', 'modalidade_migracao'),
        'uf' => $circuito->getDistinctValues('endereco', 'uf'),
        'municipio' => $circuito->getDistinctValues('endereco', 'municipio'),
        'solicitante' => $circuito->getDistinctValues('informacoes_circuito', 'solicitante'),
        'tipologia' => $circuito->getDistinctValues('informacoes_circuito', 'tipo')
    );
